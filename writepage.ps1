...
function Write-PageLine
{
    ...
    Process
    {
        ...
        [string]$Line += "<td> <span class=""sparkline sparkline-filled"" data-values = ""$Data1""></span></td>"
...
Write-PageLine -LineName "Server1" -Data1 $Values1 -Data2 $Values2 -Data3 $Values3 -Data4 $Values4 -FilePath $FilePath
$Values1 = Get-RandomArray -ArrayLength 144
$Values2 = Get-RandomArray -ArrayLength 144
$Values3 = Get-RandomArray -ArrayLength 144
$Values4 = Get-RandomArray -ArrayLength 144
